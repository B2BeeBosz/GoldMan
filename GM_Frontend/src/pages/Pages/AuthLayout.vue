  ...
  <div>
    ...
    >
      ...
      <ul class="navbar-nav">
        ...
        <router-link class="nav-item" tag="li" to="/register/index">
          <a class="nav-link">
    ...
    <div class="wrapper wrapper-full-page registeraton-bg">
      <div class="full-page registeraton-bg" :class="pageClass">
        <div class="content">
