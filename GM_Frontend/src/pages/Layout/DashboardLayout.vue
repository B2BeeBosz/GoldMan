  ...
  <div class="wrapper" :class="{ 'nav-open': $sidebar.showSidebar }">
    ...
    >
      <template slot-scope="props" slot="links">
        ...
        <sidebar-item 
          :link="{ name: $t('sidebar.inventoryManage'), 
          icon: 'tim-icons icon-app'}"
        >
          <sidebar-item
            :link="{ name: $t('sidebar.inventory'), path: '/shop/inventory'}"
          ></sidebar-item>
          <sidebar-item
            :link="{ name: $t('sidebar.buyStockInventory'), path: '/shop/buyStockInventory'}"
          ></sidebar-item>
          <sidebar-item
            :link="{ name: $t('sidebar.pledgingInventory'), path: '/shop/pledgingInventory'}"
          ></sidebar-item>
          <sidebar-item
            :link="{ name: $t('sidebar.productSettings'), path: '/shop/productSettings'}"
          ></sidebar-item>
        </sidebar-item>
        
        <sidebar-item
          :link="{ name: $t('sidebar.accounting'), icon: 'tim-icons icon-money-coins' }"
        >
          <sidebar-item 
            :link="{ name: $t('sidebar.buy_sell_acc'), path: '/shop/accounting' }"
          ></sidebar-item>
          <sidebar-item
            :link="{ name: $t('sidebar.goldPledging'), path: '/shop/pledgingAccounting'}"
          ></sidebar-item>
        </sidebar-item>
        
        <!-- <sidebar-item
          :link="{ name: $t('sidebar.manageCustomer'), 
          icon: 'fa fa-users',
          path: '/shop/manageCustomer'}"
        ></sidebar-item> -->

        <!-- <sidebar-item
          :link="{ name: $t('sidebar.manageShop'),
          icon: 'tim-icons icon-tag',
          path: '/manageShop' }"
        ></sidebar-item> -->
        <sidebar-item
          :link="{ name: $t('sidebar.manageEmployee'), 
          icon: 'tim-icons icon-badge',
          path: '/shop/manageEmployee' }"
        ></sidebar-item>

        <sidebar-item
          :link="{ name: $t('sidebar.userProfile'),
